...
class RecipeView extends View {
  ...
  _errMessage = `Recipe not found. Try another one!`;
  _message = "";
  ...
  addHandlerServing(handler) {
    this._parentEl.addEventListener("click", (e) => {
      ...
      if (
        !button ||
        (button.classList.contains("decrease") && this._data.servings === 1)
      )
        return;

      handler(+button.dataset.toserving);
    });
  }
        ...
        <div class="recipe__details">
          ...
          <div class="recipe__info">
            ...
            <div class="recipe__info-buttons">
              <button data-toserving="${
                this._data.servings - 1
              }" class="btn--tiny btn--increase-servings decrease">
                <svg>
          ...
          <button class="btn--round btn--bookmark">
            <svg class="">
              <use class="icon--bookmark" href="${icons}.svg#icon-bookmark${
